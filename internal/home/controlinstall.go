...
type getAddrsResponse struct {
	...
	// Version is the version of ADBlock-Private-DNS.
	//
...
// be set.  canAutofix is true if the port can be unbound by ADBlock-Private-DNS
...
func (req *checkConfReq) validateDNS(
	...
	case config.HTTPConfig.Address.Port():
		...
		// by ADBlock-Private-DNS for web interface.
	default:
		// Check TCP as well.
