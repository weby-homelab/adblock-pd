...
import (
	...
	"github.com/weby-homelab/adblock-pd/internal/ossvc"
...
const (
	serviceName        = "ADBlock-PD"
	serviceDisplayName = "ADBlock-Private-DNS service"
	serviceDescription = "ADBlock-Private-DNS: Network-level blocker"
)
...
func handleServiceInstallCmd(
	...
	if detectFirstRun(ctx, l, workDir, confPath) {
		slogutil.PrintLines(ctx, l, slog.LevelInfo, "", "Almost ready!\n"+
			"ADBlock-Private-DNS is successfully installed and will automatically start on boot.\n"+
			"There are a few more things that must be configured before you can use it.\n"+
			"Click on the link below and follow the Installation Wizard steps to finish setup.\n"+
			"ADBlock-Private-DNS is now available at the following addresses:")
