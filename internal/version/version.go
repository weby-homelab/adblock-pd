// Package version contains ADBlock-Private-DNS version information.
package version
...
// Channel returns the current ADBlock-Private-DNS release channel.
func Channel() (v string) {
	return channel
}

// vFmtFull defines the format of full version output.
const vFmtFull = "ADBlock-Private-DNS (Weby Homelab), version %s"

// Full returns the full current version of ADBlock-Private-DNS.
func Full() (v string) {
	return fmt.Sprintf(vFmtFull, version)
}

// GOARM returns the GOARM value used to build the current ADBlock-Private-DNS release.
func GOARM() (v string) {
	return goarm
}

// GOMIPS returns the GOMIPS value used to build the current ADBlock-Private-DNS
// release.
func GOMIPS() (v string) {
	return gomips
}

// Version returns the ADBlock-Private-DNS build version.
...
const (
	vFmtAGHHdr       = "ADBlock-Private-DNS"
	vFmtVerHdr       = "Version: "
