...
// NeedsMigration returns true if ADBlock-Private-DNS files need permission migration.
...
// Migrate attempts to change the permissions of ADBlock-Private-DNS's files.  It logs
