...
// index and transforms the filters from it to ADBlock-Private-DNS's format.
package main
...
// category returns the ADBlock-Private-DNS category for this filter.  If there is no
...
// aghFilters is the JSON structure for ADBlock-Private-DNS's list of vetted filtering
