...
mkdir -p "$dist_docker"
cp "${dist_dir}/ADBlock-PD_linux_386/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_386_"
cp "${dist_dir}/ADBlock-PD_linux_amd64/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_amd64_"
cp "${dist_dir}/ADBlock-PD_linux_arm64/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_arm64_"
cp "${dist_dir}/ADBlock-PD_linux_arm_6/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_arm_v6"
cp "${dist_dir}/ADBlock-PD_linux_arm_7/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_arm_v7"
cp "${dist_dir}/ADBlock-PD_linux_ppc64le/ADBlock-PD/ADBlock-PD" \
	"${dist_docker}/ADBlock-PD_linux_ppc64le_"
