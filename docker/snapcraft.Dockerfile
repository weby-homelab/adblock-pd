...
ARG CACHE_BUSTER=0
ARG VERSION=""
COPY --from=builder /app/ADBlock-PD_amd64.snap /ADBlock-PD_amd64.snap
COPY --from=builder /app/ADBlock-PD_arm64.snap /ADBlock-PD_arm64.snap
COPY --from=builder /app/ADBlock-PD_armhf.snap /ADBlock-PD_armhf.snap
COPY --from=builder /app/ADBlock-PD_i386.snap /ADBlock-PD_i386.snap
...
ADD snap /app/snap
ADD scripts /app/scripts
ADD ADBlock-PD_amd64.snap /app/ADBlock-PD_amd64.snap
ADD ADBlock-PD_arm64.snap /app/ADBlock-PD_arm64.snap
ADD ADBlock-PD_armhf.snap /app/ADBlock-PD_armhf.snap
ADD ADBlock-PD_i386.snap /app/ADBlock-PD_i386.snap
WORKDIR /app
RUN \
<<-'EOF'
set -e -f -u -x
